...
exports.TldsApi = exports.TldsApiApiKeys = void 0;
...
// ===============================================
var TldsApiApiKeys;
(function (TldsApiApiKeys) {
})(TldsApiApiKeys || (exports.TldsApiApiKeys = TldsApiApiKeys = {}));
class TldsApi {
    ...
    setApiKey(key, value) {
        this.authentications[TldsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param tldDto
     */
    tldCreate(companyId_1, tldDto_1) {
        return __awaiter(this, arguments, void 0, function* (companyId, tldDto, options = { headers: {} }) {
            ...
            let localVarRequestOptions = {
                ...
                json: true,
                body: models_1.ObjectSerializer.serialize(tldDto, "TldDto")
            };
                    ...
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "TldCreate200Response");
     ...
     */
    tldFind(companyId_1, tld_1, currentPage_1, perPage_1) {
        return __awaiter(this, arguments, void 0, function* (companyId, tld, currentPage, perPage, options = { headers: {} }) {
            const localVarPath = this.basePath + '/tlds';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
            ...
            if (tld !== undefined) {
                localVarQueryParameters['tld'] = models_1.ObjectSerializer.serialize(tld, "string");
            }
                ...
                return new Promise((resolve, reject) => {
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "TldFind200Response");
                                resolve({ response: response, body: body });
                            }
                            else {
                                reject(new apis_1.HttpError(response, body, response.statusCode));
     ...
     * @param tldDto
     */
    tldUpdate(companyId_1, id_1, tldDto_1) {
        return __awaiter(this, arguments, void 0, function* (companyId, id, tldDto, options = { headers: {} }) {
            const localVarPath = this.basePath + '/tlds/{id}'
                .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
