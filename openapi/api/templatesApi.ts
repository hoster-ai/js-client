...
import { TemplateCreate201Response } from '../model/templateCreate201Response';
import { TemplateDto } from '../model/templateDto';
import { TemplateFind200Response } from '../model/templateFind200Response';
...
export class TemplatesApi {
     ...
     */
    public async getTemplateIntegration (id: string, companyId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TemplateCreate201Response;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: TemplateCreate201Response;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "TemplateCreate201Response");
     ...
     * @param templateDto 
     */
    public async templateCreate (companyId: string, templateDto: TemplateDto, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TemplateCreate201Response;  }> {
     ...
     * @param companyId companyId
     */
    public async templateDelete (id: string, companyId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InvoiceGet200Response;  }> {
    ...
    public async templateFind (companyId: string, action?: 'item/create' | 'item/suspend' | 'item/unsuspend' | 'item/renew' | 'item/cancel' | 'item/delete' | 'item/upgrade' | 'item/update' | 'item/downgrade' | 'domain/create' | 'domain/lock' | 'domain/unlock' | 'domain/renew' | 'domain/bundle/add' | 'domain/bundle/remove' | 'domain/info' | 'domain/recall' | 'domain/transfer/check' | 'domain/transfer/cancel' | 'domain/transfer/accept' | 'domain/send-auth-code' | 'domain/check-availability' | 'domain/shield/activate' | 'domain/shield/deactivate' | 'domain/delete' | 'domain/contacts/info' | 'domain/contacts/create' | 'domain/contacts/update' | 'domain/contacts/delete' | 'domain/contacts/registrant' | 'domain/contacts/admin' | 'domain/contacts/tech' | 'domain/contacts/billing' | 'domain/resend-verification-email' | 'domain/check-claims' | 'domain/modify-hosts' | 'domain/modify-authcode' | 'domain/get-transfer-status' | 'domain/cancel-transfer' | 'domain/request-transfer-away' | 'domain/request-transfer' | 'domain/complete-transfer-away' | 'domain/reject-transfer-away' | 'domain/reject-transfer-expired', title?: string, currentPage?: number, perPage?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TemplateFind200Response;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: TemplateFind200Response;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "TemplateFind200Response");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param id ID
     */
    public async templateGet (companyId: string, id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TemplateCreate201Response;  }> {
        const localVarPath = this.basePath + '/templates/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param templateDto 
     */
    public async templateUpdate (companyId: string, id: string, templateDto: TemplateDto, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TemplateCreate201Response;  }> {
        const localVarPath = this.basePath + '/templates/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
